...
import {ClockIcon, FileTextIcon} from '@navikt/aksel-icons'
                                ...
                                <HStack gap="4" align="start">
                                    ...
                                    <VStack gap="4">
                                        ...
                                        <HStack gap="8">
                                            <VStack gap="1">
                                                <BodyShort
                                                    size="small"><strong>Opprettet:</strong> {sakDetaljer.opprettet}
                                                </BodyShort>
                                                <BodyShort size="small"><strong>Frist:</strong> {sakDetaljer.frist}
                                                </BodyShort>
                                            </VStack>
                                            <VStack gap="1">
                                                <BodyShort
                                                    size="small"><strong>Saksbehandler:</strong> {sakDetaljer.saksbehandler}
                                                </BodyShort>
                                                <BodyShort
                                                    size="small"><strong>Beskrivelse:</strong> {sakDetaljer.beskrivelse}
                                                </BodyShort>
                                            </VStack>
                                        </HStack>
                                    </VStack>
                                                ...
                                                {sakDetaljer.dokumenter.map((dokument, index) => (
                                                    <Panel key={index} border>
                                                        <HStack justify="space-between" align="center">
                                                            <VStack gap="1">
                                                                <BodyShort
                                                                    weight="semibold">{dokument.tittel}</BodyShort>
                                                ...
                                                {sakDetaljer.historikk.map((hendelse, index) => (
                                                    <HStack key={index} gap="3" align="start">
                                                        ...
                                                        <VStack gap="0">
                                                            ...
                                                            <BodyShort
                                                                size="small">{hendelse.dato} - {hendelse.bruker}</BodyShort>
                                                        </VStack>
                                                    </HStack>
                                                ))}
                                            </VStack>
