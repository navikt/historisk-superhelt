...
import { type Options, findSaker, createSak, findPerson2, findPerson, getUserInfo, getSakBySaksnummer, getPerson } from '../sdk.gen';
import { queryOptions, type UseMutationOptions } from '@tanstack/react-query';
import type { FindSakerData, CreateSakData, CreateSakError, CreateSakResponse, FindPerson2Data, FindPerson2Error, FindPerson2Response, FindPersonData, FindPersonError, FindPersonResponse, GetUserInfoData, GetSakBySaksnummerData, GetPersonData } from '../types.gen';
...
export const findPerson2Mutation = (options?: Partial<Options<FindPerson2Data>>): UseMutationOptions<FindPerson2Response, FindPerson2Error, Options<FindPerson2Data>> => {
    const mutationOptions: UseMutationOptions<FindPerson2Response, FindPerson2Error, Options<FindPerson2Data>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await findPerson2({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
