...
export const findSaker = <ThrowOnError extends boolean = false>(options: Options<FindSakerData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FindSakerResponses, FindSakerErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const findPerson2 = <ThrowOnError extends boolean = false>(options: Options<FindPerson2Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<FindPerson2Responses, FindPerson2Errors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
