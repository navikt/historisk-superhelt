...
import type { GetAllSakerData, GetAllSakerResponses, CreateSakData, CreateSakResponses, GetUserInfoData, GetUserInfoResponses, GetSakBySaksnummerData, GetSakBySaksnummerResponses } from './types.gen';
...
export const getAllSaker = <ThrowOnError extends boolean = false>(options?: Options<GetAllSakerData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllSakerResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const createSak = <ThrowOnError extends boolean = false>(options: Options<CreateSakData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateSakResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getSakBySaksnummer = <ThrowOnError extends boolean = false>(options: Options<GetSakBySaksnummerData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetSakBySaksnummerResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
