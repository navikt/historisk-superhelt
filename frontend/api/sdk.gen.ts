...
import type { GetAllSakerData, GetAllSakerResponses, GetAllSakerErrors, CreateSakData, CreateSakResponses, CreateSakErrors, HentPersondataMedPersonidentData, HentPersondataMedPersonidentResponses, HentPersondataMedPersonidentErrors, GetUserInfoData, GetUserInfoResponses, GetUserInfoErrors, GetSakBySaksnummerData, GetSakBySaksnummerResponses, GetSakBySaksnummerErrors } from './types.gen';
...
export const hentPersondataMedPersonident = <ThrowOnError extends boolean = false>(options: Options<HentPersondataMedPersonidentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<HentPersondataMedPersonidentResponses, HentPersondataMedPersonidentErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
