...
export const finnJournalposterForSakEllerBruker = <ThrowOnError extends boolean = false>(options: Options<FinnJournalposterForSakEllerBrukerData, ThrowOnError>) => (options.client ?? client).get<FinnJournalposterForSakEllerBrukerResponses, FinnJournalposterForSakEllerBrukerErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
