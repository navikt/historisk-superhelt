...
export const getKodeverkHjemlerForStonad = <ThrowOnError extends boolean = false>(options: Options<GetKodeverkHjemlerForStonadData, ThrowOnError>) => (options.client ?? client).get<GetKodeverkHjemlerForStonadResponses, GetKodeverkHjemlerForStonadErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
