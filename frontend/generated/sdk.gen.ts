...
export const journalforSc1bRx4 = <ThrowOnError extends boolean = false>(options: Options<JournalforSc1bRx4Data, ThrowOnError>) => (options.client ?? client).put<JournalforSc1bRx4Responses, JournalforSc1bRx4Errors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const lasdtnedDokumentFraJournalpost = <ThrowOnError extends boolean = false>(options: Options<LasdtnedDokumentFraJournalpostData, ThrowOnError>) => (options.client ?? client).get<LasdtnedDokumentFraJournalpostResponses, LasdtnedDokumentFraJournalpostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
