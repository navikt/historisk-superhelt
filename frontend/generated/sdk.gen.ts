...
export const hentSakHistorikkForSak = <ThrowOnError extends boolean = false>(options: Options<HentSakHistorikkForSakData, ThrowOnError>) => (options.client ?? client).get<HentSakHistorikkForSakResponses, HentSakHistorikkForSakErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/sakhistorikk/sak/{saksnummer}',
    ...options
});

export const hentSakHistorikkForPerson = <ThrowOnError extends boolean = false>(options: Options<HentSakHistorikkForPersonData, ThrowOnError>) => (options.client ?? client).get<HentSakHistorikkForPersonResponses, HentSakHistorikkForPersonErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
