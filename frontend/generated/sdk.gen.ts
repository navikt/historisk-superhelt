...
export const tilbakestillGjenapning = <ThrowOnError extends boolean = false>(options: Options<TilbakestillGjenapningData, ThrowOnError>) => (options.client ?? client).put<TilbakestillGjenapningResponses, TilbakestillGjenapningErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const henleggSak = <ThrowOnError extends boolean = false>(options: Options<HenleggSakData, ThrowOnError>) => (options.client ?? client).put<HenleggSakResponses, HenleggSakErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const feilregisterSak = <ThrowOnError extends boolean = false>(options: Options<FeilregisterSakData, ThrowOnError>) => (options.client ?? client).put<FeilregisterSakResponses, FeilregisterSakErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const journalforNySak = <ThrowOnError extends boolean = false>(options: Options<JournalforNySakData, ThrowOnError>) => (options.client ?? client).put<JournalforNySakResponses, JournalforNySakErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const gjenopprettOppgaver = <ThrowOnError extends boolean = false>(options?: Options<GjenopprettOppgaverData, ThrowOnError>) => (options?.client ?? client).post<GjenopprettOppgaverResponses, GjenopprettOppgaverErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const getKodeverkVedtaksResultat = <ThrowOnError extends boolean = false>(options?: Options<GetKodeverkVedtaksResultatData, ThrowOnError>) => (options?.client ?? client).get<GetKodeverkVedtaksResultatResponses, GetKodeverkVedtaksResultatErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const getKodeverkSakStatus = <ThrowOnError extends boolean = false>(options?: Options<GetKodeverkSakStatusData, ThrowOnError>) => (options?.client ?? client).get<GetKodeverkSakStatusResponses, GetKodeverkSakStatusErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const getKodeverkOppgaveType = <ThrowOnError extends boolean = false>(options?: Options<GetKodeverkOppgaveTypeData, ThrowOnError>) => (options?.client ?? client).get<GetKodeverkOppgaveTypeResponses, GetKodeverkOppgaveTypeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/oppgave/kodeverk/oppgavetype',
    ...options
});

export const getKodeverkOppgaveGjelder = <ThrowOnError extends boolean = false>(options?: Options<GetKodeverkOppgaveGjelderData, ThrowOnError>) => (options?.client ?? client).get<GetKodeverkOppgaveGjelderResponses, GetKodeverkOppgaveGjelderErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const hentInfotrygdHistorikkForPerson = <ThrowOnError extends boolean = false>(options: Options<HentInfotrygdHistorikkForPersonData, ThrowOnError>) => (options.client ?? client).get<HentInfotrygdHistorikkForPersonResponses, HentInfotrygdHistorikkForPersonErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
