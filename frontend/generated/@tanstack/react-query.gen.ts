...
export const hentSakHistorikkForSakQueryKey = (options: Options<HentSakHistorikkForSakData>) => createQueryKey('hentSakHistorikkForSak', options);

export const hentSakHistorikkForSakOptions = (options: Options<HentSakHistorikkForSakData>) => queryOptions<HentSakHistorikkForSakResponse, HentSakHistorikkForSakError, HentSakHistorikkForSakResponse, ReturnType<typeof hentSakHistorikkForSakQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await hentSakHistorikkForSak({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: hentSakHistorikkForSakQueryKey(options)
});
